...
| **Fallback Canteens**       | Select canteens as fallback. If no data is available for the active canteens, the fallback Canteens will be used.                                                                                                                                                                                 | `fallbackCanteens: ["Bambus"]`                 |
| **Fill up with fallback**   | If enabled, fallback canteens will be used to supplement missing data from selected canteens.                                                                                                                                                                                                     | `fillUpWithFallback: false`                    |
